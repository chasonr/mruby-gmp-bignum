...
=end
  ...
  assert('Bignum', 'test_str_to_inum') do
    ...
    assert_equal(111,   '111'.to_i)
    assert_equal(111,   '0111'.to_i)
    assert_equal(0,     '0b111'.to_i)
    assert_equal(111,   '0d111'.to_i)
    assert_equal(0,     '0o111'.to_i)
    assert_equal(0,     '0x111'.to_i)
    assert_equal(7,     '111'.to_i(2))
    assert_equal(7,     '0111'.to_i(2))
    assert_equal(7,     '0b111'.to_i(2))
    assert_equal(0,     '0d111'.to_i(2))
    assert_equal(0,     '0o111'.to_i(2))
    assert_equal(0,     '0x111'.to_i(2))
    assert_equal(73,    '111'.to_i(8))
    assert_equal(73,    '0111'.to_i(8))
    assert_equal(0,     '0b111'.to_i(8))
    assert_equal(0,     '0d111'.to_i(8))
    assert_equal(73,    '0o111'.to_i(8))
    assert_equal(0,     '0x111'.to_i(8))
    assert_equal(111,   '111'.to_i(10))
    assert_equal(111,   '0111'.to_i(10))
    assert_equal(0,     '0b111'.to_i(10))
    assert_equal(111,   '0d111'.to_i(10))
    assert_equal(0,     '0o111'.to_i(10))
    assert_equal(0,     '0x111'.to_i(10))
    assert_equal(273,   '111'.to_i(16))
    assert_equal(273,   '0111'.to_i(16))
    assert_equal(45329, '0b111'.to_i(16))
    assert_equal(53521, '0d111'.to_i(16))
    assert_equal(0,     '0o111'.to_i(16))
    assert_equal(273,   '0x111'.to_i(16))

    #NotImp assert_equal(111, Integer("111"))
    assert_equal(13, "111".to_i(3))
    assert_raise(ArgumentError) { "111".to_i(63) }
  ...
  assert('Bignum', 'test_to_s2') do
    assert_raise(ArgumentError) { T31P.to_s(63) }
    if Float === 32768 then
